---
description: "Determine whether a defined version and artifact set is ready to release without performing publication, tagging, or deployment."
argument-hint: "[TASK_CONTEXT]"
---

# /release-check

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/release-check.command.md`.
