---
description: "Create, rewrite, or synchronize a professional project README from current repository evidence."
argument-hint: "[TASK_CONTEXT]"
---

# /readme-refresh

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/readme-refresh.command.md`.
