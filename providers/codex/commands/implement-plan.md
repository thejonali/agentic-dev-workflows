---
description: "Execute an approved plan as a focused change while preserving scope, recording deviations, and producing verification evidence."
argument-hint: "[TASK_CONTEXT]"
---

# /implement-plan

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/implement-plan.command.md`.
