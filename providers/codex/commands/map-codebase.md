---
description: "Produce a concise, evidence-based map of a repository without modifying it."
argument-hint: "[TASK_CONTEXT]"
---

# /map-codebase

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/map-codebase.command.md`.
