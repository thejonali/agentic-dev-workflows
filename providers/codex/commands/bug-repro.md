---
description: "Reproduce a reported defect deterministically and identify the likely failing code path before a fix is attempted."
argument-hint: "[TASK_CONTEXT]"
---

# /bug-repro

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/bug-repro.command.md`.
