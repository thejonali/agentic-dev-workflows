---
description: "Define a reviewable image-asset specification before prompts are generated or asset creation begins."
argument-hint: "[TASK_CONTEXT]"
---

# /image-brief

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/image-brief.command.md`.
