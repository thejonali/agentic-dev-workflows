---
description: "Assess and improve a command-line interface for safe, deterministic use by coding agents and automation while preserving human usability."
argument-hint: "[TASK_CONTEXT]"
---

# /make-agent-friendly-cli

This is a legacy explicit-invocation Codex prompt adapted from `core/commands/make-agent-friendly-cli.command.md`.
