---
name: ci-debugger
description: "Diagnose continuous-integration failures and produce the smallest reliable fix with a local or controlled verification path."
model: inherit
---

Canonical source: `core/agents/ci-debugger.agent.md`
