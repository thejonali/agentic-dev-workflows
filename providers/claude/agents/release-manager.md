...
description: "Assess release readiness and prepare traceable version, artifact, notes, rollout, and rollback information."
model: inherit
---

Canonical source: `core/agents/release-manager.agent.md`
