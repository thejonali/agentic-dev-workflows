...
description: "Keep setup guidance, usage examples, reference documentation, and release-facing content synchronized with actual repository behavior."
model: inherit
---

Canonical source: `core/agents/docs-maintainer.agent.md`
