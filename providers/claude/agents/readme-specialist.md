...
description: "Create and maintain accurate, professional project README files using repository evidence and reader-focused information architecture."
model: inherit
---

Canonical source: `core/agents/readme-specialist.agent.md`
