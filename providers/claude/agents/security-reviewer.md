...
description: "Identify practical security vulnerabilities and trust-boundary mistakes in a defined change or system surface."
model: inherit
---

Canonical source: `core/agents/security-reviewer.agent.md`
