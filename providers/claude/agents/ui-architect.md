---
name: ui-architect
description: "Plan interface hierarchy, component boundaries, responsive behavior, data states, and accessibility requirements before implementation."
model: inherit
---

Canonical source: `core/agents/ui-architect.agent.md`
