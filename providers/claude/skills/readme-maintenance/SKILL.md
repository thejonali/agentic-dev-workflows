...
description: "Create and maintain professional project README files that accurately explain the product, architecture, use cases, installation, usage, testing, licensing, and project status without overstating unverified capabilities."
---
