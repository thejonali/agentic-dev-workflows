---
name: review
description: "Evaluate a proposed change for correctness, regressions, security, contracts, operability, and maintainability, then provide prioritized actionable findings."
---
